...
echo $c "   /                                 \  ${endc}";
echo $c "  /   https://github.com/RaElyaCyber   \ ${endc}";
...
echo  "+===========================================+" |lolcat
echo  "+ Team     : [OP] CyberTeam $white            + " |lolcat
echo  "+ Author   : RaElya_Cyber $white                         + " |lolcat
echo  "+ Youtube  : RaelyaCyber $white                   + " |lolcat
echo  "+===========================================+" |lolcat

echo $r"•••••••••••••••••••••••••••••••••••••••••••••${endc}";
echo   "##### Kumpulan Tools V3 2019-2020! #####" |lolcat
echo $r"•••••••••••••••••••••••••••••••••••••••••••••${endc}";
...
Trying To Exit ... "
echo  $cyan"[#]> Subscribe chanel RaelyaCyber"
sleep 1
echo ""
...
00) echo "Tq Byee | RaElya_Cyber" |lolcat
exit
